          ...
          <div className="bg-blue-600 rounded-lg p-8 text-white">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <svg className="h-6 w-6 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <div className="ml-4">
                  <p className="text-lg font-medium">Address</p>
                  <p className="mt-1">Rruga Skenderbeu, Drenas 13000, Kosovo</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1">info@poliklinika.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1">Saturday: 9:00 AM - 5:00 PM</p>
                  <p className="mt-1">Sunday: Emergency Only</p>
                </div>
              </div>
            </div>
          </div>
